...
|---|---|---|
| `USER` (작성자) | **본인이 작성한 것만** | — |
| `ORG_ADMIN` (기관관리자) | 자기 기관 소속 전체 | 자기 기관 사용자 추가·수정 |
...
관리자 화면(`/admin`)에서 보이는 탭은 권한마다 다릅니다.

| 권한 | 등록 현황 | 주차별 현황판 | 사용자 관리 | 활동 로그 |
|---|---|---|---|---|
| 총괄관리자 | ○ | ○ | ○ (전체) | ○ |
| 감독관리자 | — | ○ | — | — |
| 중복권한 (기관관리자) | — | ○ | ○ (자기 기관) | — |
...
기관관리자는 자기 기관 사람만 보이고, 작성자·기관관리자 권한만 줄 수 있습니다.
계정 삭제와 중복권한 부여는 총괄관리자만 합니다.
